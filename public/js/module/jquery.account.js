...
$('form#email_notification').newForm({
	handler:'sendEmail',
	errorMessageClass:'.errors',
	commonErrorSeclector:'_error',
	button: 'button#sendEmail',
	requestURL: '/send-notification/',
	successMessage: 'Your email has been send successfully.',
	dropzoneRequired: false,
});
$('form#create_user').newForm({
	handler:'create',
	errorMessageClass:'.errors',
	commonErrorSeclector:'_error',
	button: 'button#create',
	requestURL: '/user/store/',
	successMessage: 'New user has been created successfully.',
	dropzoneRequired: false,
});

$('form#create_customer').newForm({
	handler:'create_cust',
	errorMessageClass:'.errors',
	commonErrorSeclector:'_error',
